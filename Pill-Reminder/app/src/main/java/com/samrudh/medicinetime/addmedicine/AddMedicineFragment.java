...
import com.samrudh.medicinetime.R;
import com.samrudh.medicinetime.alarm.ReminderActivity;
import com.samrudh.medicinetime.alarm.ReminderFragment;
import com.samrudh.medicinetime.data.source.MedicineAlarm;
import com.samrudh.medicinetime.data.source.Pills;
import com.samrudh.medicinetime.views.DayViewCheckBox;
import com.samrudh.medicinetime.views.RobotoBoldTextView;
...
public class AddMedicineFragment extends Fragment implements AddMedicineContract.View {
    ...
    private View.OnClickListener setClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (isEmpty(editMedName)) {
                Toast.makeText(getContext(), "You did not enter a Medicine name", Toast.LENGTH_SHORT).show();
                return;

            } else if (count==0) {
                Toast.makeText(getContext(), "You did not enter Days", Toast.LENGTH_SHORT).show();
                return;
            } else if (count1==0) {
                Toast.makeText(getContext(), "You did not enter Timings", Toast.LENGTH_SHORT).show();
                return;
            }
            else {
